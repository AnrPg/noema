/**
 * @noema/knowledge-graph-service - MCP Tool Type Definitions
 *
 * Shared types for the MCP Agent Tool layer.
 * IToolResult re-exports IToolExecutionResult from @noema/contracts.
 *
 * Follows the content-service tool.types.ts pattern exactly.
 */
...
export interface IToolDefinition {
  /** Unique tool name (kebab-case, e.g. 'get-concept-node') */
  name: string;
