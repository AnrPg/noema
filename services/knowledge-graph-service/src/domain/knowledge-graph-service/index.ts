...
export type {
  ...
  OntologyEndpointResolutionState,
...
export {
  ...
  NormalizedOntologyRelationCandidateV2Schema,
  OntologyAccessModeSchema,
  OntologyArtifactKindSchema,
  OntologyEndpointResolutionStateSchema,
  ...
  OntologyRelationReviewStateSchema,
  OntologyRunTriggerSchema,
  OntologySourceIdSchema,
  OntologySourceRoleSchema,
  ParsedOntologyGraphBatchSchema,
  RelationBlockingReasonSchema,
  RelationInferenceReasonSchema,
  ResolvedRelationEndpointSchema,
  SourceRelationCandidateSchema,
  SourceRelationHintSchema,
} from './ontology-imports.contracts.js';
