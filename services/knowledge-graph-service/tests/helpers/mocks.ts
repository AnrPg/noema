...
export function mockKnowledgeGraphService(): {
  ...
  return {
    ...
    getNodeStabilitySummary: vi.fn().mockImplementation(notConfigured),
    ...
    rejectStuckMutation: vi.fn().mockImplementation(notConfigured),
...
export function mockMutationRepository(): {
  ...
  return {
    ...
    getLatestMutationByState: vi.fn().mockImplementation(notConfigured),
    getLatestCommittedMutationByAudit: vi.fn().mockImplementation(notConfigured),
    ...
    updateMutationFields: vi.fn().mockImplementation(notConfigured),
  };
}
