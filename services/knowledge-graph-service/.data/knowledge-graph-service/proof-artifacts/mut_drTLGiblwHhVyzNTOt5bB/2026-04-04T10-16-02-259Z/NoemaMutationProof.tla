...
CurrentNodeIds == {"node_PqRyGuRSbx43RQUJONoFx", "node_xDd1I3GkgsUJDEq066koO", "node_nafRzTSpI8snbolZTBooS", "node_eLkZAzsM1TXe1FqiiFStY"}
ProjectedNodeIds == {"node_eLkZAzsM1TXe1FqiiFStY", "node_nafRzTSpI8snbolZTBooS", "node_PqRyGuRSbx43RQUJONoFx", "node_xDd1I3GkgsUJDEq066koO"}
ProjectedNodes == {<<"node_eLkZAzsM1TXe1FqiiFStY", "concept", "skills-and-occupations", "existing">>, <<"node_nafRzTSpI8snbolZTBooS", "concept", "skills-and-occupations", "existing">>, <<"node_PqRyGuRSbx43RQUJONoFx", "concept", "skills-and-occupations", "existing">>, <<"node_xDd1I3GkgsUJDEq066koO", "concept", "skills-and-occupations", "existing">>}
ProjectedNodeClassifications == {<<"node_eLkZAzsM1TXe1FqiiFStY", {"knowledge_entity", "concept_bearing", "abstraction"}>>, <<"node_nafRzTSpI8snbolZTBooS", {"knowledge_entity", "concept_bearing", "abstraction"}>>, <<"node_PqRyGuRSbx43RQUJONoFx", {"knowledge_entity", "concept_bearing", "abstraction"}>>, <<"node_xDd1I3GkgsUJDEq066koO", {"knowledge_entity", "concept_bearing", "abstraction"}>>}
ProjectedEdges == {<<"edge_C6OQ7LdRIVQdraZ-gcWF5", "is_a", "node_xDd1I3GkgsUJDEq066koO", "node_nafRzTSpI8snbolZTBooS", "existing">>, <<"edge_NGQrHLbDieKaoewm3PuJv", "is_a", "node_PqRyGuRSbx43RQUJONoFx", "node_eLkZAzsM1TXe1FqiiFStY", "existing">>, <<"proof:mut_drTLGiblwHhVyzNTOt5bB:edge:0:add", "is_a", "node_PqRyGuRSbx43RQUJONoFx", "node_xDd1I3GkgsUJDEq066koO", "planned_add">>}
