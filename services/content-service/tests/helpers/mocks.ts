...
export function mockContentRepository(): {
  ...
  return {
    ...
    query: vi.fn(),
    queryActivityPayloadCandidates: vi.fn(),
    createGeneratedActivityVariant: vi.fn(),
    queryCursor: vi.fn(),
    count: vi.fn(),
    findByIds: vi.fn(),
    ...
    getLineage: vi.fn(),
    getCoverageForConcept: vi.fn().mockResolvedValue(null),
    refreshCoverage: vi.fn().mockResolvedValue([]),
    create: vi.fn(),
