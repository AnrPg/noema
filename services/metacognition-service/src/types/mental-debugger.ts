/**
 * Mental Debugger Types
 *
 * Failure taxonomy and diagnostic types for the Metacognition Service.
 * Based on the 7-frame cognitive stack trace model.
 *
 * These types are specific to the metacognition-service and should not
 * be imported by other services directly.
 */
