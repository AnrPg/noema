...
export const BATCH_IMPORT_FILE_TYPES: IBatchImportFileTypeDefinition[] = [
  {
    ...
    formats: createFormats([
      ...
      [
        ...
        'Objects are already close to concept payloads but still need explicit mapping.',
      ...
      [
        ...
        'Useful for lossless migrations from operational systems.',
      ],
    ]),
  },
  {
    ...
    formats: createFormats([
      ...
      [
        ...
        'Works well for lightweight payload exports.',
      ],
      [
        'jsonl-rich-records',
        'Rich records with extras',
        'Line objects include additional metadata you want to preserve.',
        'Lets you promote only a subset of fields into payloads.',
      ],
    ]),
  },
  {
    ...
    formats: createFormats([
      [
        ...
        'The most predictable format for atomic payload imports.',
      ],
      [
      ...
      [
        ...
        'Only some columns become payload fields and the rest should be preserved.',
        'Useful for exhaustive imports from messy operational sheets.',
      ],
    ]),
  },
  {
  ...
  },
  {
    ...
    formats: createFormats([
      ...
      [
        ...
        'Only part of the sheet becomes payload fields and the rest becomes dump metadata.',
        'Useful for preserving surrounding context from planning sheets.',
      ],
    ]),
  },
  {
    ...
    label: 'Plain Text',
    extensions: '.txt',
    description: 'Human-authored text files that can still be segmented into payload records.',
    insight: 'Best for simple notes that are not already tabular.',
    formats: createFormats([
      [
        'txt-front-back-blocks',
        'Front/back blocks',
        'Separate payloads by blank lines and use --- between front and back.',
        'The clearest authored plain-text import pattern.',
      ],
      [
        'txt-question-answer-markers',
        'Q:/A: markers',
        'Each payload uses explicit labels like Q: and A:.',
      ...
      [
        ...
        'Useful when you want to scaffold payloads from outlines.',
      ],
    ]),
  },
  {
    ...
    formats: createFormats([
      ...
      [
        ...
        'Useful for imported study guides with rich formatting.',
      ],
    ]),
  },
  {
    ...
    insight: 'Best when semantic LaTeX macros already delimit payload-shaped content.',
    formats: createFormats([
      [
        'latex-card-command',
        'Payload command macros',
        'Payloads are written as macros like \\payload{front}{back}.',
        'The cleanest LaTeX-native import path.',
      ],
      [
        'latex-front-back-environment',
        'Front/back environments',
        'Payloads are wrapped in an environment with explicit front and back blocks.',
        'Useful for structured technical authoring workflows.',
      ],
      [
  ...
  },
  {
    ...
    formats: createFormats([
      [
        'typst-card-function',
        'Payload functions',
        'Items are authored with a function like #payload(front: ..., back: ...).',
      ...
      [
        ...
        'Useful for mixed prose documents with simple semantics.',
      ],
    ]),
  },
];
