...
## [0.1.1](https://github.com/AnrPg/noema/compare/noema-v0.1.0...noema-v0.1.1) (2026-04-19)
...
* **events:** add aggregation lifecycle events ([d67bc17](https://github.com/AnrPg/noema/commit/d67bc178709d595cd2ec14b84a8dd1bdf9a3745a))
...
* **kg-service:** add pkg aggregation proposal runtime ([dfa0d89](https://github.com/AnrPg/noema/commit/dfa0d8918b17caf358972ce782924cc631504610))
...
* **knowledge-graph-service:** add graph snapshot storage and restore repository support ([147781e](https://github.com/AnrPg/noema/commit/147781ed5451f4488b9841de2b462a75f9d99e34))
...
* **knowledge-graph-service:** add layer 3 crdt stats runtime ([e38d42c](https://github.com/AnrPg/noema/commit/e38d42cbfe59d47d7c5c28a5092b603fe4e969bc))
...
* **knowledge-graph-service:** add ontology reasoning validation stage ([8f85533](https://github.com/AnrPg/noema/commit/8f8553307a305373e584d3f8eab38975e89ee5a4))
* **knowledge-graph-service:** add ontology-aware proofing ([867822c](https://github.com/AnrPg/noema/commit/867822cca734083cd74566e3f50763a610e5b5d0))
...
* **knowledge-graph-service:** add unity invariant validation stage ([f6e681f](https://github.com/AnrPg/noema/commit/f6e681f1d02974dc3a0770b7a126db1836906f82))
...
* **knowledge-graph-service:** classify and publish pkg advisories ([5d272b8](https://github.com/AnrPg/noema/commit/5d272b831e387543c12979a156760e6b81cfabaf))
* **knowledge-graph-service:** enforce proof rollout modes ([518f905](https://github.com/AnrPg/noema/commit/518f9053f0d56c729ab949c03b0c435e5656f3c2))
* **knowledge-graph-service:** enforce stratified graph dependency boundaries ([8f7b016](https://github.com/AnrPg/noema/commit/8f7b01607e53636b00e553157637276cfe005544))
...
* **knowledge-graph-service:** expose graph crdt stats inspection api ([7e5c3bf](https://github.com/AnrPg/noema/commit/7e5c3bfa81550f2510b153a37b23cf8c70837fc2))
* **knowledge-graph-service:** expose graph snapshot restore workflows ([d1ac9f7](https://github.com/AnrPg/noema/commit/d1ac9f72971a9cf102d9d0d629ae78b50edd1f7e))
* **knowledge-graph-service:** extend graph safety persistence ([ad68828](https://github.com/AnrPg/noema/commit/ad688283011eac7288608724c498d95654edd44f))
* **knowledge-graph-service:** harden restore and recovery flows ([d85e65f](https://github.com/AnrPg/noema/commit/d85e65f75794682d80ab390eb54ab349fadf6571))
...
* **ui:** turn neural gauge into a shared speedometer ([fb3fde6](https://github.com/AnrPg/noema/commit/fb3fde62e4504d7e23287522e17887386d87af08))
* **ui:** turn neural gauge into a shared speedometer ([abd74d3](https://github.com/AnrPg/noema/commit/abd74d38634d4121d2a1700278948034238ebe3d))
...
* **web:** streamline graph authoring workspaces ([7775d86](https://github.com/AnrPg/noema/commit/7775d86e7f8b14cf8d86614aba0a85cc32b5457a))
...
* **knowledge-graph-service:** align ckg reset imports with lint rules ([5fcd8d8](https://github.com/AnrPg/noema/commit/5fcd8d8fbb954273f07e251769a156d95315c1fb))
...
* **knowledge-graph-service:** tighten graph snapshot pagination typing ([cafda40](https://github.com/AnrPg/noema/commit/cafda408cad6d037ce2a71b5b59e27c9e4b98eb3))
...
* **web:** share session speedometers and wrap mobile rows ([a91eb5e](https://github.com/AnrPg/noema/commit/a91eb5e996b4cee91e3fe276c3cabfe366893075))
...
* add dual-graph hardening adrs ([abe73b9](https://github.com/AnrPg/noema/commit/abe73b9b7df1d1876bc4ebac319b14de8fb1a3da))
...
* **architecture:** document enforced graph layer mapping ([3654809](https://github.com/AnrPg/noema/commit/36548098d5a789960fcac61a08da69bbee2ea4cd))
...
* **frontend:** note the shared speedometer progress pattern ([01c3d5c](https://github.com/AnrPg/noema/commit/01c3d5c9a0cf55bf8d6090b26fb2c26ff7911fd4))
...
* update living graph architecture maps ([d1396b2](https://github.com/AnrPg/noema/commit/d1396b24996532067672d35e2f3a6942f5de1d3c))
...
* **knowledge-graph-service:** cover graph crdt stats phase ([b900ba3](https://github.com/AnrPg/noema/commit/b900ba39d9a90586f531b730a702892b02f21d20))
* **knowledge-graph-service:** cover graph snapshot restore workflows ([bd8a7f1](https://github.com/AnrPg/noema/commit/bd8a7f181373b5d9de173f3a28bd241cd1a57a24))
* **knowledge-graph-service:** cover ontology reasoning stage ([6a91329](https://github.com/AnrPg/noema/commit/6a91329649a3a469ce755639944e5e4265e8b741))
* **knowledge-graph-service:** cover pkg advisory write paths ([1814921](https://github.com/AnrPg/noema/commit/18149210e317d89a6dc0c0e5e90c34a21a8cace1))
* **knowledge-graph-service:** cover proof rollout modes ([b058a24](https://github.com/AnrPg/noema/commit/b058a24a1f297657a18a2fba194f9d58f4889964))
* **knowledge-graph-service:** cover stratified dependency checker ([49b819a](https://github.com/AnrPg/noema/commit/49b819a774781c282f4bf5264b0d95a7c211f2fd))
* **knowledge-graph-service:** cover unity invariant stage ([4103ac2](https://github.com/AnrPg/noema/commit/4103ac28aa30de544ab02ee20b7b653fa42f3c00))
