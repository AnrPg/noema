...
This specification defines the REQUIRED structure for all REST APIs in Noema.
All service APIs MUST conform to this specification (OpenAPI 3.1) to ensure
consistency, agent-friendliness, and proper documentation.
...
APIs must be agent-first (include agentHints), well-documented, and consistent
across all services.

---

**Note:** This is the MINIMUM API structure. Add additional endpoints, custom
filters, batch operations, webhooks, GraphQL mutations, or domain-specific
operations as your service requires.
...
All endpoints MUST include version in URL: `/v1/cards`, `/v2/cards`
