      ...
      parserOptions: {
        projectService: {
          allowDefaultProject: [
            ...
            'services/content-service/tests/*.ts',
            'services/content-service/tests/*/*.ts',
            'services/content-service/tests/*/*/*.ts',
            'services/curriculum-service/tests/*.ts',
            'services/curriculum-service/tests/*/*.ts',
            'services/curriculum-service/tests/*/*/*.ts',
            'services/ingestion-service/tests/*.ts',
            'services/ingestion-service/tests/*/*.ts',
            'services/ingestion-service/tests/*/*/*.ts',
            ...
            'services/pedagogy-guardian-service/tests/*/*.ts',
            'services/pedagogy-guardian-service/tests/*/*/*.ts',
            'services/session-service/tests/*.ts',
            'services/session-service/tests/*/*.ts',
            'services/session-service/tests/*/*/*.ts',
            'services/vector-service/tests/*.ts',
            'services/vector-service/tests/*/*.ts',
            'services/vector-service/tests/*/*/*.ts',
          ],
        },
